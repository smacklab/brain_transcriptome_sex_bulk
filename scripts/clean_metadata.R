...
# Read in metadata
meta.technical = read.delim('data/cayo_brain_bulk_metadata_technical_final.txt',stringsAsFactors=FALSE)
meta.animal = read.delim('data/cayo_brain_bulk_metadata_animals_final.tsv',stringsAsFactors=FALSE)
